...
This document describes the eight agents available on OpenSeaBri, who they are designed for, and how to reach them. (Moved out of the coding-agent adapter `AGENTS.md`, which now carries only agent-instruction content.)
